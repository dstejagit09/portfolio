/* Totobot Widget for saitejadasari.com */
(function () {
  'use strict';
  ...
  var FALLBACK = {
    ...
    'Education at ASU': '**MS Robotics and Autonomous Systems** at Arizona State University (Aug 2024 to May 2026), GPA **3.89/4.0**. Coursework includes Aerial Robotics, Mechatronics, Multi-Robot Systems, and Controls and Systems. He is also a TA for MATLAB Programming and Controls labs. [View specs](https://saitejadasari.com/#telemetry)',
    ...
    'GPA & certifications': 'GPA: **3.89/4.0** (MS Robotics, ASU). Certifications: **Universal Robots e-Series** (Core and Pro), **MathWorks AI** (ML and DL), **Hugging Face RL**, and **Udemy ROS and ROS2**. Publication: *SCADA-Based Substation Control Panel and Operations*. [View manifest](https://saitejadasari.com/#manifest)',
